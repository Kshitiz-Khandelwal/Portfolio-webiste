...
export function Hero() {
  ...
  return (
    <section className="relative min-h-[92vh] flex items-center justify-center pt-28 pb-16 px-4 sm:px-6 overflow-hidden ambient-grid">
      ...
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[400px] bg-[#D4AF37]/10 rounded-full blur-[120px] pointer-events-none -z-10" />
      <div className="absolute bottom-10 right-10 w-[400px] h-[300px] bg-[#DC143C]/5 rounded-full blur-[100px] pointer-events-none -z-10" />
      ...
      <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
        ...
        <div className="lg:col-span-7 flex flex-col items-start text-left z-10">
          ...
          <div className="flex flex-wrap items-center gap-2 mb-6">
            <span className="px-3 py-1 rounded-full bg-white border border-[#D4AF37]/50 font-mono text-xs text-[#D4AF37] font-bold shadow-xs">
              AI / ML
            </span>
            <span className="text-slate-300">•</span>
            <span className="px-3 py-1 rounded-full bg-white border border-slate-200 font-mono text-xs text-slate-700 shadow-xs">
              Full Stack
            </span>
            <span className="text-slate-300">•</span>
            <span className="px-3 py-1 rounded-full bg-white border border-slate-200 font-mono text-xs text-slate-700 shadow-xs">
          ...
          <h1 className="font-sans font-extrabold text-4xl sm:text-6xl lg:text-6xl text-slate-900 tracking-tight leading-[1.1] mb-3">
            Kshitiz Khandelwal
          </h1>
          ...
          <p className="font-sans text-base sm:text-lg text-slate-700 max-w-xl leading-relaxed mb-8">
            ...
            <span className="text-slate-900 font-semibold underline decoration-[#D4AF37]/50">cybersecurity threat filtering</span>,{" "}
            <span className="text-slate-900 font-semibold underline decoration-[#DC143C]/50">privacy-preserving healthcare AI</span>, and{" "}
            <span className="text-slate-900 font-semibold underline decoration-slate-400">real-time embedded hardware</span>.
          </p>

          {/* Terminal Card: $ whoami */}
          <div className="w-full max-w-xl bg-white border border-slate-200 rounded-2xl p-4 sm:p-5 shadow-md mb-8 font-mono text-xs text-slate-800 relative overflow-hidden">
            <div className="flex items-center justify-between pb-3 mb-3 border-b border-slate-100">
              <div className="flex items-center gap-2">
                <div className="w-3 h-3 rounded-full bg-[#DC143C]" />
                <div className="w-3 h-3 rounded-full bg-[#D4AF37]" />
                <div className="w-3 h-3 rounded-full bg-emerald-500" />
                <span className="text-slate-400 text-[11px] ml-2">bash — kshitiz@workstation</span>
              </div>
            ...
            <div className="space-y-1.5 leading-relaxed">
              ...
              <div className="text-slate-700 pl-3 border-l-2 border-[#D4AF37] space-y-0.5 font-medium">
          ...
          <div className="flex flex-wrap items-center gap-3 w-full sm:w-auto">
            <a
              ...
              className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-[#D4AF37] text-slate-900 font-sans font-bold text-sm hover:bg-[#FFD700] shadow-sm transition-all active:scale-[0.98]"
            >
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 px-5 py-3 rounded-xl bg-white text-slate-800 border border-slate-200 hover:border-[#D4AF37] text-sm font-sans font-medium hover:text-[#D4AF37] shadow-xs transition-all active:scale-[0.98]"
            >
        ...
        <div className="lg:col-span-5 flex flex-col items-center justify-center z-10">
          <div className="relative w-full max-w-md bg-white border border-slate-200 hover:border-[#D4AF37] rounded-3xl p-4 sm:p-5 shadow-xl transition-all duration-300">
            {/* Technical Frame Top Coordinate Bar */}
            <div className="flex items-center justify-between pb-3 mb-3 border-b border-slate-100 font-mono text-[10px] text-slate-500">
            ...
            <div className="relative aspect-[4/5] rounded-2xl overflow-hidden bg-slate-100 border border-slate-200 group">
              <Image
                src="/profile.jpg"
            ...
            <div className="flex items-center justify-between pt-3 mt-3 border-t border-slate-100 font-mono text-[10px] text-slate-600">
