...
export function GitHubSection() {
  const pinnedRepos = [
    {
      ...
      url: "https://github.com/Kshitiz-Khandelwal",
    },
    {
  ...
  return (
    <section id="github" className="py-20 px-4 sm:px-6 max-w-7xl mx-auto border-t border-slate-200">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        {pinnedRepos.map((repo) => (
          <a
            ...
            className="p-6 rounded-3xl bg-white border border-slate-200 hover:border-[#D4AF37] shadow-xs hover:shadow-md transition-all group flex flex-col justify-between"
          >
            <div>
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-2 text-slate-900 group-hover:text-[#D4AF37] transition-colors">
            ...
            <div className="pt-3 border-t border-slate-100 flex items-center justify-between font-mono text-[11px] text-slate-500">
              <span className="text-[#D4AF37] font-bold">{repo.tech}</span>
      ...
      <div className="text-center">
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-white border border-slate-200 hover:border-[#D4AF37] text-xs font-mono text-slate-800 hover:text-[#D4AF37] shadow-xs transition-all"
        >
