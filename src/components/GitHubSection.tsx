...
export function GitHubSection() {
  ...
  return (
    <section id="github" className="py-20 px-4 sm:px-6 max-w-7xl mx-auto bg-[#271A38] rounded-3xl my-8 border border-[#3D2B55]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        {pinnedRepos.map((repo) => (
          <a
            ...
            className="p-6 rounded-3xl bg-[#1F142D] border border-[#3D2B55] hover:border-[#A78BFA] shadow-violet hover:shadow-violet-lg transition-all group flex flex-col justify-between"
          >
            <div>
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-2 text-[#E5DAF7] group-hover:text-[#A78BFA] transition-colors">
                ...
                <ExternalLink className="w-3.5 h-3.5 text-[#A99BC2] group-hover:text-[#A78BFA]" />
              </div>
            ...
            <div className="pt-3 border-t border-[#3D2B55] flex items-center justify-between font-mono text-[11px] text-[#A99BC2]">
              <span className="text-[#A78BFA] font-semibold">{repo.tech}</span>
              <span className="group-hover:text-[#A78BFA] transition-colors">Open Repository →</span>
            </div>
          </a>
        ))}
      </div>
      ...
      <div className="text-center">
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-[#1F142D] border border-[#3D2B55] hover:border-[#A78BFA] text-xs font-sans text-[#E5DAF7] hover:text-[#A78BFA] shadow-violet transition-all"
        >
