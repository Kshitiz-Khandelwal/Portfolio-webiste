...
export function OtherProjectsAndIoT() {
  ...
  return (
    <section id="other-projects" className="py-20 px-4 sm:px-6 max-w-7xl mx-auto bg-[#271A38] rounded-3xl my-8 border border-[#3D2B55]">
      {/* Video Demonstrations Vault Banner */}
      <div className="bg-[#1F142D] border border-[#3D2B55] rounded-3xl p-6 sm:p-10 mb-12 shadow-violet">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8">
          <div>
            ...
            <h3 className="font-sans font-bold text-2xl sm:text-3xl text-[#E5DAF7]">
          ...
          {/* Primary Violet CTA Button */}
          <a
            href={driveFolderUrl}
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2.5 px-5 py-2.5 rounded-xl bg-[#A78BFA] text-[#1A1025] font-bold text-xs sm:text-sm hover:bg-[#C4B5FD] hover:shadow-violet-lg transition-all shadow-violet shrink-0"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {videoDemos.map((demo) => (
            <div
              ...
              className="bg-[#271A38] border border-[#3D2B55] hover:border-[#A78BFA] rounded-2xl p-5 flex flex-col justify-between group transition-all duration-300 hover:-translate-y-1.5 hover:shadow-violet shadow-violet cursor-pointer select-none relative"
            >
              <div>
                <div className="flex items-center justify-between mb-3 pb-2 border-b border-[#3D2B55]">
                  <span className={`font-mono text-[10px] uppercase tracking-wider px-2 py-0.5 rounded-md font-semibold ${demo.badgeClass}`}>
                    {demo.category}
                  </span>
                  <div className="w-8 h-8 rounded-full bg-[#1F142D] border border-[#3D2B55] flex items-center justify-center text-[#A78BFA] group-hover:scale-110 group-hover:bg-[#A78BFA] group-hover:text-[#1A1025] transition-all shadow-xs">
                    <Play className="w-3.5 h-3.5 fill-current ml-0.5" />
                  </div>
                </div>

                <h4 className="font-sans font-bold text-base text-[#E5DAF7] group-hover:text-[#A78BFA] transition-colors mb-2">
                  {demo.title}
                </h4>
              ...
              <div>
                {/* Tech Tags */}
                <div className="flex flex-wrap gap-1.5 pt-3 border-t border-[#3D2B55] mb-4">
                  {demo.tags.map((tag) => (
                    <span
                      key={tag}
                      className="px-2 py-0.5 rounded text-[10px] font-mono font-medium badge-subtle"
                    >
                      {tag}
                    </span>
                  ))}
                ...
                <div className="inline-flex items-center gap-2 text-xs font-medium text-[#A78BFA] group-hover:text-[#C4B5FD] transition-colors">
      ...
      {activeVideoModal && (
        ...
        >
          <div
            className="relative w-full max-w-4xl bg-[#271A38] border border-[#3D2B55] rounded-3xl p-4 sm:p-6 shadow-violet-lg overflow-hidden"
          ...
          >
            ...
            <div className="flex items-center justify-between pb-3 mb-3 border-b border-[#3D2B55]">
              <div className="flex items-center gap-2">
                ...
                <h3 className="font-sans font-bold text-base sm:text-lg text-[#E5DAF7]">
              ...
              <div className="flex items-center gap-2">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="hidden sm:inline-flex items-center gap-1.5 px-3 py-1 rounded-lg bg-[#1F142D] border border-[#3D2B55] text-xs font-mono text-[#C4B5FD] hover:text-[#A78BFA] transition-colors"
                >
                ...
                <button
                  onClick={() => setActiveVideoModal(null)}
                  className="p-2 rounded-xl bg-[#1F142D] border border-[#3D2B55] text-[#A99BC2] hover:text-white transition-colors"
                >
                  <X className="w-5 h-5" />
                </button>
              </div>
            ...
            <div className="relative aspect-[16/10] w-full rounded-2xl overflow-hidden bg-[#1F142D] border border-[#3D2B55]">
              {isVideoLoading && (
                <div className="absolute inset-0 flex flex-col items-center justify-center bg-[#1A1025] z-10 space-y-3">
                  <Loader2 className="w-8 h-8 text-[#A78BFA] animate-spin" />
                  <span className="font-mono text-xs text-[#E5DAF7]">
            ...
            {/* Description Footer */}
            <div className="pt-3 mt-3 border-t border-[#3D2B55] flex flex-col sm:flex-row sm:items-center justify-between gap-2">
              <p className="font-sans text-xs text-[#C4B5FD]">
                {activeVideoModal.description}
              </p>
              <span className="font-mono text-[10px] text-[#A78BFA] shrink-0 font-semibold">
      ...
      <div className="relative bg-[#1F142D] border border-[#3D2B55] hover:border-[#A78BFA] rounded-3xl p-6 sm:p-8 mt-12 mb-8 shadow-violet transition-all duration-300">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          {/* Left: Project Details */}
          <div className="lg:col-span-7 space-y-4">
            <div className="flex flex-wrap items-center gap-2 pb-2 border-b border-[#3D2B55]">
              <span className="font-mono text-[10px] uppercase tracking-wider px-2.5 py-1 rounded-full badge-violet font-semibold">
                {zephyrProject.badge}
              </span>
              <span className="font-mono text-[10px] text-[#A99BC2]">
            ...
            <h3 className="font-sans font-bold text-2xl text-[#E5DAF7]">
              {zephyrProject.title}
            </h3>
            <p className="font-sans text-xs sm:text-sm text-[#A78BFA] font-medium">
            ...
            {/* Highlights with Emerald Checkmarks */}
            ...
            {/* Tech Tags */}
            <div className="flex flex-wrap gap-1.5 pt-3 border-t border-[#3D2B55]">
            ...
            <div className="pt-3">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-[#271A38] border border-[#3D2B55] hover:border-[#A78BFA] text-xs font-sans text-[#E5DAF7] hover:text-[#A78BFA] shadow-violet transition-all"
              >
          ...
          <div className="lg:col-span-5">
            <div
              className="relative aspect-[4/3] rounded-2xl overflow-hidden bg-[#271A38] border border-[#3D2B55] hover:border-[#A78BFA] shadow-violet group cursor-pointer transition-all duration-300"
            ...
            >
              ...
              />
              <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-[#1A1025]/90 via-[#1A1025]/40 to-transparent p-3 flex items-center justify-between pointer-events-none">
                <div>
                ...
                <span className="font-mono text-[10px] bg-[#A78BFA] px-2 py-0.5 rounded text-[#1A1025] font-bold">
                  🔍 Zoom
                </span>
              </div>
            </div>
